...
def create_counter(metric_name: str,
                   metric_help: str,
    ...
    '''
    return utils.create_metric_family(metric_name,
                                      metric_help,
                                      COUNTER,
                                      metrics,
                                      timestamp=timestamp,
...
def create_gauge(metric_name: str,
                 metric_help: str,
                 metrics: Union[Sequence[Metric], Sequence[utils.MetricTupleType]],
                 timestamp: bool = False,
                 const_labels: utils.LabelsType = None,
...
def create_summary(metric_name: str,
                   metric_help: str,
                   metrics: Union[Sequence[Metric], Sequence[utils.MetricTupleType]],
                   timestamp: bool = False,
                   const_labels: utils.LabelsType = None,
...
def create_histogram(metric_name: str,
                     metric_help: str,
                     metrics: Union[Sequence[Metric], Sequence[utils.MetricTupleType]],
                     timestamp: bool = False,
                     const_labels: utils.LabelsType = None,
