...
class ApiTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.summary_metric_data = (
            (
                {"host": "examplehost", "route": "/"},
                {0.5: 4.0, 0.9: 5.2, 0.99: 5.2, "sum": 25.2, "count": 4},
            ),
            (
                {"host": "examplehost", "route": "/data"},
                {0.5: 4.0, 0.9: 5.2, 0.99: 5.2, "sum": 25.2, "count": 4},
            ),
        )
        ...
        self.histogram_metric_data = (
            (
                {"host": "examplehost", "route": "/"},
                {5.0: 3, 10.0: 2, 15.0: 1, POS_INF: 0, "sum": 25.2, "count": 4},
            ),
            (
                {"host": "examplehost", "route": "/data"},
                {5.0: 3, 10.0: 2, 15.0: 1, POS_INF: 0, "sum": 25.2, "count": 4},
    ...
    def test_create_counter(self):
        ...
        mf = pmp.create_counter(self.counter_metric_name, self.counter_metric_help, [])
    ...
    def test_create_gauge(self):
        ...
        # Create a metrics with no metric instances
        mf = pmp.create_gauge(self.gauge_metric_name, self.gauge_metric_help, [])
        self.assertIsInstance(mf, pmp.MetricFamily)
        self.assertEqual(len(mf.metric), 0)
    ...
    def test_create_summary(self):
        ...
        # Create a metrics with no metric instances
        mf = pmp.create_summary(self.summary_metric_name, self.summary_metric_help, [])
        self.assertIsInstance(mf, pmp.MetricFamily)
        self.assertEqual(len(mf.metric), 0)
    ...
    def test_create_histogram(self):
        ...
        mf = pmp.create_histogram(
            self.histogram_metric_name, self.histogram_metric_help, []
        )
        self.assertIsInstance(mf, pmp.MetricFamily)
        self.assertEqual(len(mf.metric), 0)
    ...
    def test_encode_decode(self):
        ...
        self.assertIn(
            "Expected metrics to be instances of MetricFamily, got ", str(ctx.exception)
        )
